package com.dlwx.hzquser.model;
...
public class ModeImpl implements ModeInterface {
    @Override
    public void loadData(final LoadListener loadListener, Map<String,String> map, boolean isget,String url,String cachKey,boolean iscach) {
        ...
        if (isget) {
            ...
            if (iscach) {
                stringGetRequest.cacheKey(cachKey);
