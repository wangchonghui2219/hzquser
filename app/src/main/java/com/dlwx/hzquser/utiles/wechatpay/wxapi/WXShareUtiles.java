package com.dlwx.hzquser.utiles.wechatpay.wxapi;
...
import com.dlwx.hzquser.utiles.Utils;
...
public class WXShareUtiles {
    ...
    public void share2weixin(int style) {
        ...
        msg.title = "合之奇";
        msg.description = "%"+ MyApplication.Exten_Code+"@,快来加入我们吧";
        try
        {
    ...
    public void wxTextShare(int style){
        ...
        textObject.text = "ssssssss";

        WXMediaMessage mediaMessage = new WXMediaMessage();
        mediaMessage.mediaObject = textObject;
        mediaMessage.description = "ssssssss";
     ...
     */
    public void wxImgShare(int style,Bitmap bmp){
        if (!api.isWXAppInstalled()) {
            Toast.makeText(ctx, "您还未安装微信客户端",
                    Toast.LENGTH_SHORT).show();
            return;
        ...
        Bitmap thumbBmp = Bitmap.createScaledBitmap(bmp, 150, 150, true);
//                bmp.recycle();//使用之后回收
        message.thumbData = Utils.bmpToByteArray(thumbBmp);
