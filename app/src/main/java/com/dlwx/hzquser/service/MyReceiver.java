package com.dlwx.hzquser.service;
...
//			Log.d(TAG, "[MyReceiver] onReceive - " + intent.getAction() + ", extras: " + printBundle(bundle));
			...
			if (JPushInterface.ACTION_REGISTRATION_ID.equals(intent.getAction())) {
				...
				Intent inten = null;
				inten = new Intent(context, MessCenterActivity.class);
                        inten.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TOP );
                        context.startActivity(inten);

				Gson gson = new Gson();
//				notiFicaBean = gson.fromJson(extraJson, NotiFicaBean.class);
//                //0全部2代发货订单3待收货订单
//                if (notiFicaBean.getIsseller()== 0) {//不是商家
//                    Intent inten = null;
//                    int state = notiFicaBean.getState();
//                    if (state == 0) {
//                        inten = new Intent(context, AllOrderActivity.class);
//                        inten.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TOP );
//                        context.startActivity(inten);
//                    }else if (state == 2) {
//                        inten = new Intent(context, ShippingActivity.class);
//                        inten.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TOP );
//                        context.startActivity(inten);
//                    } else if (state == 3) {
//                        inten = new Intent(context, ForthegoodsActivity.class);
//                        inten.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TOP );
//                        context.startActivity(inten);
//                    }
//
...
//                   //0待处理1已完成
//
//                    inten = new Intent(context, OrderDisposeActivity.class);
//                    inten.putExtra("position",notiFicaBean.getState());
//					inten.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TOP );
//                    context.startActivity(inten);
//                }
//                //打开自定义的Activity
//				Intent i = new Intent(context, ShippingActivity.class);
//				i.putExtras(bundle);
...
//		}
	...
	private void showNot(String mess){
		Intent inten = null;
		inten = new Intent(ctx, MessCenterActivity.class);
		inten.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TOP );
